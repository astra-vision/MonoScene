...
If you find this work or code useful, please cite our [paper](https://arxiv.org/abs/2112.00726) and [give us a star](https://github.com/cv-rits/MonoScene/stargazers):
```
...
You also need to install omegaconf and hydra-core packages, used by the visualization scripts:
```
