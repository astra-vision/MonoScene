...
1. Download the Full **Semantic Scene Completion dataset (v1.1)** and **KITTI Odometry Benchmark calibration data** from the [SemanticKITTI website](http://www.semantic-kitti.org/dataset.html).
